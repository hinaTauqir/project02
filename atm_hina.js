...
let agan = true;
let k = 0;
let userinfo = [{ user_id: "a12", user_pin: 12345 }, { user_id: "b12", user_pin: 12346 },
    { user_id: "c12", user_pin: 12347 }, { user_id: "d12", user_pin: 12348 }, { user_id: "e12", user_pin: 12349 }];
let userdata = [{ name: "aa", bankName: "aa", cardExpDate: "1 april", balance: "100RS" },
...
let askQuestion = async () => {
    ...
    if (k == 3) {
        console.log(`          ${chalk.red('INVALID: you are not allowed to login anymore')} \n`);
        agan = false;
    }
};
